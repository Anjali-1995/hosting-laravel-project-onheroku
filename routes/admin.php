...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'branch', 'as' => 'branch.'], function () {
            ...
            Route::prefix('{branchId}/inventory')->group(function(){
                Route::get('list',[InventoryController::class,'listAdmin'])->name('list_inventory');
                Route::get('/',[InventoryController::class,'createAdmin'])->name('inventory_form');
                Route::post('/',[InventoryController::class,'addToInventoryAdmin'])->name('add-to-inventory');
                Route::post('/{inventoryId}',[InventoryController::class,'substractFromInventoryAdmin'])->name('substract-from-inventory');
                
            });
        });

        Route::group(['prefix'=>'ingredient', 'as'=>'ingredient.'],function(){
            Route::get('/',[IngredientController::class,'create'])->name('create');
            Route::post('/',[IngredientController::class,'add'])->name('store');
            Route::get('list/',[IngredientController::class,'list'])->name('list');
        });
        ...
        Route::prefix('tags')->group(function(){
            Route::get('list',[TagsController::class,'index'])->name('list-tags');
            Route::get('',[TagsController::class,'create'])->name('add-tags');
            Route::post('store',[TagsController::class,'store'])->name('store-tags');
        });
