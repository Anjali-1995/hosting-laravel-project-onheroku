...
Route::group(['namespace' => 'Branch', 'as' => 'branch.'], function () {
    ...
    Route::group(['middleware' => ['branch']], function () {
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.'], function () {
            Route::post('available-branch', 'OrderController@analyze_availability')->name('avail-check');
        ...
        Route::group(['prefix' => 'order', 'as' => 'order.'], function () {
            // Route::get('anal-avail', 'OrderController@analyze_availability')->name('avail-check');
            Route::get('list/{status}', 'OrderController@list')->name('list');
        ...
        Route::prefix('inventory')->group(function(){
            Route::get('list',[InventoryController::class,'listBranch'])->name('list_inventory');
            Route::get('/',[InventoryController::class,'createBranch'])->name('inventory-form');
            Route::post('/',[InventoryController::class,'addToInventoryBranch'])->name('add-to-inventory');
