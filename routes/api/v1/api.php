...
Route::group(['namespace' => 'Api\V1'], function () {
    ...
    Route::group(['prefix' => 'auth', 'namespace' => 'Auth'], function () {
        ...
        Route::post('social','CustomerAuthController@SocialLogin');
    ...
    Route::post('request-pantry',[BranchLocationController::class,'get_pantry'])->middleware('auth:api');
    ...
    Route::group(['prefix' => 'categories'], function () {
        ...
        Route::get('reviews/{category_id}', 'CategoryController@get_category_reviews');
    });
    ...
    Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
        ...
        Route::group(['prefix' => 'order'], function () {
            ...
            Route::post('track', 'OrderController@payment_successful');
    ...
    Route::prefix('tags')->group(function(){
        Route::get('{id}',[TagsController::class,'get_all_products_by_tags']);
    });
...
//Route::middleware('auth:api', 'role:admin, foo')->apiResource('users', 'UserController@foo');
