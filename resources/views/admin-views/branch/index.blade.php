            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i
                            class="tio-add-circle-outlined"></i> {{trans('messages.add')}} {{trans('messages.new')}} {{trans('messages.branch')}}
                    </h1>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.branch.store')}}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label class="input-label" for="">{{trans('Road')}}</label>
                                <input type="text" name="road" class="form-control" placeholder="Ex : XYZ ROAD">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label class="input-label" for="">{{trans('City')}}</label>
                                <input type="text" name="city" class="form-control" placeholder="Ex : Hydrabad">
                            </div>
                        </div>
                       
                        <div class="col-12">
                            <div class="form-group">
                                <label class="input-label" for="">{{trans('Pin code')}}</label>
                                <input type="text" name="pin" class="form-control" placeholder="Ex : 12345">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                        ...
                                        <!-- Dropdown -->
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    ...
                                                    <a class="dropdown-item" href="{{route('admin.branch.list_inventory',['branchId'=>$branch['id']])}}">{{trans('Inventory')}}</a>
                                                    @if($branch['id']!=1)
