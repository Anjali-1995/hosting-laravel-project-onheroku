        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="javascript:" method="post" id="product_form"
                    ...
                    <div class="col-12">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlSelect1">{{trans('Tags')}}<span
                                        class="input-label-secondary"></span></label>
                                <select name="tags[]" class="form-control js-select2-custom" multiple="multiple">
                                    @foreach(\App\Tags::orderBy('key')->get() as $addon)
                                        <option value="{{$addon['id']}}">{{$addon['key']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    <!--===== The ingredient will be in a loop so that multiple ingredient can be added  =====-->
                    <div class="form-group">
                                <label class="input-label" for="exampleFormControlSelect1">{{trans('Ingredients')}}<span
                                        class="input-label-secondary"></span></label>
                                <select name="ingredients[]" class="form-control js-select2-custom" multiple="multiple">
                                    @foreach(\App\Ingredients::orderBy('name')->get() as $ingredient)
                    ...
                    <!--Nutiruents-->
                    <div class="form-group">
                        <label class="input-label" for="exampleFormControlInput1">{{trans('glycemic_index')}}</label>
                        <input type="number" name="glycemic_index" class="form-control"  required>
                    </div>
                    <div class="form-group">
                        <label class="input-label" for="exampleFormControlInput1">{{trans('glycemic_load')}}</label>
                        <input type="number" name="glycemic_load" class="form-control"  required>
                    </div>
                    <div class="form-group">
                        <label class="input-label" for="exampleFormControlInput1">{{trans('score')}}</label>
                        <input type="number" name="score" class="form-control"  required>
                    </div>
                    <div class="form-group">
                        <label class="input-label" for="exampleFormControlInput1">{{trans('protein')}}</label>
                        <input type="number" name="protein" class="form-control"  required>
                    </div>
                    <div class="form-group">
                        <label class="input-label" for="exampleFormControlInput1">{{trans('Calories')}}</label>
                        <input type="number" name="calories" class="form-control"  required>
                    </div>
                    <div class="form-group">
                        <label class="input-label" for="exampleFormControlInput1">{{trans('Carbs')}}</label>
                        <input type="number" name="carbs" class="form-control"  required>
                    </div>
                    <div class="form-group">
                        <label class="input-label" for="exampleFormControlInput1">{{trans('Energy')}}</label>
                        <input type="number" name="energy" class="form-control"  required>
                    </div>
                    <div class="form-group">
                        <label class="input-label" for="exampleFormControlInput1">{{trans('Fats')}}</label>
                        <input type="number" name="fats" class="form-control"  required>
                    </div>
                    <div class="form-group">
                        <label class="input-label" for="exampleFormControlInput1">{{trans('Fiber')}}</label>
                        <input type="number" name="fiber" class="form-control"  required>
                    </div>
                    <div class="form-group">
                        <label class="input-label" for="exampleFormControlInput1">{{trans('Sugar')}}</label>
                        <input type="number" name="sugar" class="form-control"  required>
                    </div>
                    <div class="form-group">
                        <label class="input-label" for="exampleFormControlInput1">{{trans('Suggestion')}}</label>
                    ...
                    <div class="form-group">
                        <label class="input-label" for="exampleFormControlInput1">{{trans('Suggestion')}} {{trans('Procedure')}}</label>
                        <textarea type="text" name="procedure[0]" class="form-control"></textarea>
                    </div>
