            ...
            <div class="card-body">
                <div class="row align-items-md-center gx-md-5">
                    ...
                    <div class="col-4 pt-2">
                        ...
                        <span>
                            {{trans('messages.available')}} {{trans('messages.time')}} {{trans('messages.starts')}} : {{$product['available_time_starts']}}
                        </span><br>
                        <span>
                            {{trans('messages.available')}} {{trans('messages.time')}} {{trans('messages.ends')}} : {{$product['available_time_ends']}}
                        </span>
