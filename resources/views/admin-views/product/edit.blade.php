        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-edit"></i> {{trans('messages.product')}} {{trans('messages.update')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                        ...
                        <div class="col-md-4 col-6">
                            <div class="form-group">
                                ...
                                <select name="tax_type" class="form-control js-select2-custom">
                                    <option value="percent" {{$product['tax_type']=='percent'?'selected':''}}>{{trans('messages.percent')}}
                                    </option>
                                    <option value="amount" {{$product['tax_type']=='amount'?'selected':''}}>{{trans('messages.amount')}}
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-6">
                            <div class="form-group">
                                ...
                                <select name="item_type" class="form-control js-select2-custom">
                                    <option value="0" {{$product['set_menu']==0?'selected':''}}>{{trans('messages.product')}} {{trans('messages.item')}}</option>
                                    <option value="1" {{$product['set_menu']==1?'selected':''}}>{{trans('messages.set_menu')}}</option>
                                </select>
                            </div>
                        </div>
                    </div>
