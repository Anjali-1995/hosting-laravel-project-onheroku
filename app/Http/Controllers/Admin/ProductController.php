...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            "ingredient_price"=>"required",

            "glycemic_index"=>"required",
            "glycemic_load"=>"required",
            "score"=>"required",
            "protein"=>"required",
            "calories"=>"required",
            "carbs"=>"required",
        ...
        $procedure   = json_encode($request->get('procedure',[]));
        Recipe::create([
            'product_id'=>$p->id,
        ...
        $glycemic_index = $request->get('glycemic_index');
        $glycemic_load = $request->get('glycemic_load');
        ...
        $ingred_name = $request->get('ingredient_name');
        $ingred_quantity = $request->get('ingredient_quantity');
        $ingred_price   = $request->get('ingredient_price');
        $ingred_min_quantity = $request->get('ingredient_min_quantity',1);

        Ingredients::create([
            "product_id"=>$p->id ,
            "quantity"=>$ingred_quantity ,
            "name"=>$ingred_name ,
            "price"=>$ingred_price ,
            "minimum_integer"=>$ingred_min_quantity
        ]);
